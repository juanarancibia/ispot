    ...
    return (
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            <a
                ...
                className="social-btn flex items-center gap-2.5 px-6 py-3 rounded-full text-sm font-medium border transition-all duration-300 hover:-translate-y-0.5"
                style={{
                ...
                onMouseLeave={(e) => {
                    e.currentTarget.style.background = "var(--theme-input)";
            ...
            <a
                ...
                onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.color = "white";
                    e.currentTarget.style.boxShadow = "0 10px 20px rgba(220, 39, 67, 0.2)";
                }}
                onMouseLeave={(e) => {
                    e.currentTarget.style.background = "var(--theme-input)";
                    e.currentTarget.style.borderColor = "var(--theme-border-strong)";
